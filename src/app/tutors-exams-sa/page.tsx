        ...
        <div className="bg-white rounded-3xl shadow-xl p-12 max-w-4xl mx-auto">
          ...
          <div className="space-y-6 text-gray-700 leading-relaxed">
            <h2 className="text-2xl md:text-3xl font-extrabold text-gray-900">
              Tutors and Exams South Africa
            </h2>
            <p>
              Tutors & Exams South Africa is a fully accredited private
              examination centre, approved by Pearson Edexcel, Cambridge
              International Education, and the Independent Examinations Board
              (IEB). With exam centres in Centurion and Cape Town, Tutors &
              Exams South Africa provides safe, calm, and accessible
              environments for candidates of all ages and backgrounds. This
              includes home-educated learners, distance learners, private
              candidates, and those who may have been excluded from mainstream
              education.
            </p>

            <p>
              We prioritise accessibility and inclusivity and are deeply
              committed to the safety and wellbeing of every candidate,
              regardless of age, ability, gender identity, race, or religious
              belief.
            </p>

            <p>
              At Tutors & Exams South Africa, candidates can expect professional
              guidance and personalised support from registration through to
              results.
            </p>
          </div>
        </div>
